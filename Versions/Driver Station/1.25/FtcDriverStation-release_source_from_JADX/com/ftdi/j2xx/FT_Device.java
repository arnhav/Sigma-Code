...
public class FT_Device {
    ...
    public FT_Device(Context parentContext, UsbManager usbManager, UsbDevice dev, UsbInterface itf) {
        ...
        try {
            ...
            this.f19f = null;
            this.f34u = 0;
            this.f21h = new C0016r();
            this.f22i = new C0015q();
            ...
            switch (this.f20g.bcdDevice & 65280) {
                case 512:
                    if (this.f20g.iSerialNumber != null) {
                        this.f20g.type = 1;
                        this.f30q = new C0137e(this);
                        break;
                    }
                    this.f30q = new C0138f(this);
                    this.f20g.type = 0;
                    break;
                case 1024:
                    this.f30q = new C0138f(this);
                    ...
                    break;
                case 1280:
                    this.f30q = new C0136d(this);
                    this.f20g.type = 4;
                    m19n();
                    break;
                case 1536:
                    this.f30q = new C0009k(this);
                    short a = (short) (this.f30q.m44a((short) 0) & 1);
                    this.f30q = null;
                    if (a != (short) 0) {
                        this.f20g.type = 5;
                        this.f30q = new C0141i(this);
                        break;
                    }
                    this.f20g.type = 5;
                    this.f30q = new C0140h(this);
                    break;
                case 1792:
                    this.f20g.type = 6;
                    m19n();
                    this.f30q = new C0135c(this);
                    break;
                case 2048:
                    this.f20g.type = 7;
                    m19n();
                    this.f30q = new C0142j(this);
                    break;
                case 2304:
                    this.f20g.type = 8;
                    this.f30q = new C0139g(this);
                    break;
                case 4096:
                    this.f20g.type = 9;
                    this.f30q = new C0143l(this);
                    break;
                case 5888:
                    this.f20g.type = 12;
                    this.f20g.flags = 2;
    ...
    public int read(byte[] data, int length, long wait_ms) {
        ...
        return this.f29p.m72a(data, length, wait_ms);
    }
    ...
    public int getQueueStatus() {
        ...
        return this.f29p.m78c();
    }

    public boolean readBufferFull() {
        return this.f29p.m75a();
    }
    ...
    public boolean setChars(byte eventChar, byte eventCharEnable, byte errorChar, byte errorCharEnable) {
        C0016r c0016r = new C0016r();
        c0016r.f141a = eventChar;
        c0016r.f142b = eventCharEnable;
        c0016r.f143c = errorChar;
        c0016r.f144d = errorCharEnable;
        if (!isOpen()) {
            return false;
        }
    ...
    public short eepromWrite(FT_EEPROM eeData) {
        if (isOpen()) {
            return this.f30q.m48a(eeData);
        }
        return (short) -1;
    }

    public boolean eepromErase() {
        if (isOpen() && this.f30q.m56c() == 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean eepromWriteWord(short address, short data) {
        if (isOpen()) {
            return this.f30q.m51a(address, data);
        }
        return false;
    }
