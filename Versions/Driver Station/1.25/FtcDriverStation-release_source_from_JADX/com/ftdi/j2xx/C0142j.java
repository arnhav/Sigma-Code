...
class C0142j extends C0009k {
    C0142j(FT_Device fT_Device) throws D2xxException {
        super(fT_Device);
        m41a((byte) 12);
    }

    short m417a(FT_EEPROM ft_eeprom) {
        ...
        try {
            ...
            i2 = m43a(ft_eeprom_4232h.Product, iArr, m43a(ft_eeprom_4232h.Manufacturer, iArr, i2, 7, z), 8, z);
            if (ft_eeprom_4232h.SerNumEnable) {
                m43a(ft_eeprom_4232h.SerialNumber, iArr, i2, 9, z);
            }
    ...
    FT_EEPROM m416a() {
        ...
        m49a(ft_eeprom_4232h, iArr[4]);
        m50a((Object) ft_eeprom_4232h, iArr[5]);
        if ((iArr[5] & 4096) == 4096) {
        ...
        int i = iArr[7] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST;
        if (this.a == (short) 70) {
            ft_eeprom_4232h.Manufacturer = m47a((i - 128) / 2, iArr);
            ft_eeprom_4232h.Product = m47a(((iArr[8] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) - 128) / 2, iArr);
            ft_eeprom_4232h.SerialNumber = m47a(((iArr[9] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) - 128) / 2, iArr);
            return ft_eeprom_4232h;
        }
        ft_eeprom_4232h.Manufacturer = m47a(i / 2, iArr);
        ft_eeprom_4232h.Product = m47a((iArr[8] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        ft_eeprom_4232h.SerialNumber = m47a((iArr[9] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        return ft_eeprom_4232h;
    }
    ...
    int m415a(byte[] bArr) {
        ...
        int b = (short) (((this.b - (m419b() / 2)) - 1) - 1);
        int i = 0;
        while (i < bArr.length) {
            int i2;
            if (i + 1 < bArr.length) {
    ...
    byte[] m418a(int i) {
        ...
        short b = (short) (((this.b - (m419b() / 2)) - 1) - 1);
        int i2 = 0;
        while (i2 < i) {
            short s = (short) (b + 1);
            int a = m44a(b);
