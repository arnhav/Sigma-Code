...
public class FT_4222_Device {
    ...
    protected C0005b mChipStatus;
    protected FT_Device mFtDev;
    protected C0008e mGpio;
    protected C0004a mSpiMasterCfg;

    public FT_4222_Device(FT_Device ftDev) {
        this.TAG = "FT4222";
        this.mFtDev = ftDev;
        this.mChipStatus = new C0005b();
        this.mSpiMasterCfg = new C0004a();
        this.mGpio = new C0008e();
    }
    ...
    public int init() {
        ...
        this.mChipStatus.m40a(bArr);
        return 0;
    }

    public int setClock(byte clk) {
        if (clk == this.mChipStatus.f71f) {
            return 0;
        }
    ...
    protected int getMaxBuckSize() {
        if (this.mChipStatus.f68c != null) {
            return 64;
        }
        switch (this.mChipStatus.f66a) {
