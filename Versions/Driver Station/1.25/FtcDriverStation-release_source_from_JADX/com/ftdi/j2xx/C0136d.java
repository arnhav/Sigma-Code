...
class C0136d extends C0009k {
    C0136d(FT_Device fT_Device) throws D2xxException {
        super(fT_Device);
        m41a((byte) 10);
    }

    short m367a(FT_EEPROM ft_eeprom) {
        ...
        try {
            ...
            i = m43a(ft_eeprom_2232d.Product, iArr, m43a(ft_eeprom_2232d.Manufacturer, iArr, i, 7, z), 8, z);
            if (ft_eeprom_2232d.SerNumEnable) {
                m43a(ft_eeprom_2232d.SerialNumber, iArr, i, 9, z);
            }
            iArr[10] = this.a;
    ...
    FT_EEPROM m366a() {
        ...
        m49a(ft_eeprom_2232d, iArr[4]);
        i = iArr[7] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST;
        if (this.a == (short) 70) {
            ft_eeprom_2232d.Manufacturer = m47a((i - 128) / 2, iArr);
            ft_eeprom_2232d.Product = m47a(((iArr[8] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) - 128) / 2, iArr);
            ft_eeprom_2232d.SerialNumber = m47a(((iArr[9] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) - 128) / 2, iArr);
            return ft_eeprom_2232d;
        }
        ft_eeprom_2232d.Manufacturer = m47a(i / 2, iArr);
        ft_eeprom_2232d.Product = m47a((iArr[8] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        ft_eeprom_2232d.SerialNumber = m47a((iArr[9] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        return ft_eeprom_2232d;
    }
    ...
    int m365a(byte[] bArr) {
        ...
        int b = (short) (((this.b - (m369b() / 2)) - 1) - 1);
        int i = 0;
        while (i < bArr.length) {
            int i2;
            if (i + 1 < bArr.length) {
    ...
    byte[] m368a(int i) {
        ...
        short b = (short) (((this.b - (m369b() / 2)) - 1) - 1);
        int i2 = 0;
        while (i2 < i) {
            short s = (short) (b + 1);
            int a = m44a(b);
