...
class C0139g extends C0009k {
    C0139g(FT_Device fT_Device) throws D2xxException {
        super(fT_Device);
        m41a((byte) 15);
    }

    short m400a(FT_EEPROM ft_eeprom) {
        ...
        try {
            ...
            int a = m43a(ft_eeprom_232h.Product, iArr, m43a(ft_eeprom_232h.Manufacturer, iArr, 80, 7, false), 8, false);
            if (ft_eeprom_232h.SerNumEnable) {
                m43a(ft_eeprom_232h.SerialNumber, iArr, a, 9, false);
            }
            iArr[10] = 0;
            iArr[11] = 0;
            iArr[12] = 0;
    ...
    FT_EEPROM m399a() {
        ...
        if ((iArr[0] & Command.MAX_COMMAND_LENGTH) > 0) {
        ...
        m49a(ft_eeprom_232h, iArr[4]);
        m50a((Object) ft_eeprom_232h, iArr[5]);
        switch (iArr[6] & 3) {
            case SpiSlaveResponseEvent.OK /*0*/:
        ...
        ft_eeprom_232h.Manufacturer = m47a((iArr[7] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        ft_eeprom_232h.Product = m47a((iArr[8] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        ft_eeprom_232h.SerialNumber = m47a((iArr[9] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        return ft_eeprom_232h;
    }

    int m402b() {
        int a = m44a((short) 9);
        int i = ((a & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2) + 1;
        return (((this.b - i) - 1) - ((((a & 65280) >> 8) / 2) + 1)) * 2;
    }

    int m398a(byte[] bArr) {
        if (bArr.length > m402b()) {
            return 0;
        }
        int[] iArr = new int[this.b];
        ...
        int b = (short) (((this.b - (m402b() / 2)) - 1) - 1);
        int i = 0;
        while (i < bArr.length) {
            int i2;
            if (i + 1 < bArr.length) {
    ...
    byte[] m401a(int i) {
        ...
        short b = (short) (((this.b - (m402b() / 2)) - 1) - 1);
        int i2 = 0;
        while (i2 < i) {
            short s = (short) (b + 1);
            int a = m44a(b);
