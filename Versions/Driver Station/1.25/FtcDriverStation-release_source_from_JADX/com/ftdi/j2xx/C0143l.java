...
class C0143l extends C0009k {
    private static FT_Device f635d;

    C0143l(FT_Device fT_Device) {
        super(fT_Device);
        f635d = fT_Device;
    ...
    short m422a(FT_EEPROM ft_eeprom) {
        ...
        try {
            ...
            if (fT_EEPROM_X_Series.InvertTXD) {
                iArr[5] = iArr[5] | Command.MAX_COMMAND_LENGTH;
            }
            ...
            int a = m43a(fT_EEPROM_X_Series.Product, iArr, m43a(fT_EEPROM_X_Series.Manufacturer, iArr, 80, 7, false), 8, false);
            if (fT_EEPROM_X_Series.SerNumEnable) {
                m43a(fT_EEPROM_X_Series.SerialNumber, iArr, a, 9, false);
            }
            iArr[10] = fT_EEPROM_X_Series.I2CSlaveAddress;
            iArr[11] = fT_EEPROM_X_Series.I2CDeviceID & 65535;
    ...
    boolean m425b(int[] iArr, int i) {
        int i2 = 43690;
        int i3 = 0;
        do {
            int i4 = iArr[i3] & 65535;
            m51a((short) i3, (short) i4);
            i2 = (i2 ^ i4) & 65535;
            i4 = (i2 << 1) & 65535;
            if ((i2 & 32768) > 0) {
                i2 = 1;
    ...
    FT_EEPROM m421a() {
        ...
        m49a(fT_EEPROM_X_Series, iArr[4]);
        m50a((Object) fT_EEPROM_X_Series, iArr[5]);
        if ((iArr[5] & 16) > 0) {
        ...
        fT_EEPROM_X_Series.I2CDeviceID |= (iArr[12] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) << 16;
        fT_EEPROM_X_Series.CBus0 = (byte) (iArr[13] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST);
        fT_EEPROM_X_Series.CBus1 = (byte) ((iArr[13] >> 8) & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST);
        fT_EEPROM_X_Series.CBus2 = (byte) (iArr[14] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST);
        fT_EEPROM_X_Series.CBus3 = (byte) ((iArr[14] >> 8) & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST);
        fT_EEPROM_X_Series.CBus4 = (byte) (iArr[15] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST);
        fT_EEPROM_X_Series.CBus5 = (byte) ((iArr[15] >> 8) & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST);
        fT_EEPROM_X_Series.CBus6 = (byte) (iArr[16] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST);
        this.a = (short) (iArr[73] >> 8);
        fT_EEPROM_X_Series.Manufacturer = m47a((iArr[7] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        fT_EEPROM_X_Series.Product = m47a((iArr[8] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        fT_EEPROM_X_Series.SerialNumber = m47a((iArr[9] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
    ...
    int m420a(byte[] bArr) {
        ...
        int b = (short) (((this.b - (m424b() / 2)) - 1) - 1);
        int i = 0;
        while (i < bArr.length) {
            int i2;
            if (i + 1 < bArr.length) {
        ...
        if (iArr[1] == 0 || iArr[2] == 0 || !m425b(iArr, this.b - 1)) {
            return 0;
        }
        return bArr.length;
    }
    ...
    byte[] m423a(int i) {
        ...
        short b = (short) (((this.b - (m424b() / 2)) - 1) - 1);
        int i2 = 0;
        while (i2 < i) {
            short s = (short) (b + 1);
            int a = m44a(b);
