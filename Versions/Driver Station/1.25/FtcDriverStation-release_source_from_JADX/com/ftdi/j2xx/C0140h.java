...
class C0140h extends C0009k {
    private static FT_Device f633d;

    C0140h(FT_Device fT_Device) {
        super(fT_Device);
        f633d = fT_Device;
    }

    boolean m406a(short s, short s2) {
        boolean z = false;
        int i = s2 & 65535;
        int i2 = s & 65535;
        if (s < D2xxManager.FT_FLOW_XON_XOFF) {
            byte latencyTimer = f633d.getLatencyTimer();
            f633d.setLatencyTimer((byte) 119);
            if (f633d.m28c().controlTransfer(64, 145, i, i2, null, 0, 0) == 0) {
                z = true;
            }
            f633d.setLatencyTimer(latencyTimer);
        }
        return z;
    }

    short m405a(FT_EEPROM ft_eeprom) {
        ...
        try {
            ...
            i2 = m43a(ft_eeprom_232r.Product, iArr, m43a(ft_eeprom_232r.Manufacturer, iArr, 12, 7, true), 8, true);
            if (ft_eeprom_232r.SerNumEnable) {
                m43a(ft_eeprom_232r.SerialNumber, iArr, i2, 9, true);
            }
    ...
    FT_EEPROM m404a() {
        ...
        try {
            ...
            m49a(ft_eeprom_232r, iArr[4]);
            m50a((Object) ft_eeprom_232r, iArr[5]);
            ...
            ft_eeprom_232r.Manufacturer = m47a(((iArr[7] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) - 128) / 2, iArr);
            ft_eeprom_232r.Product = m47a(((iArr[8] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) - 128) / 2, iArr);
            ft_eeprom_232r.SerialNumber = m47a(((iArr[9] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) - 128) / 2, iArr);
    ...
    int m403a(byte[] bArr) {
        ...
        int b = (short) (((short) ((63 - (m408b() / 2)) - 1)) & 65535);
        int i = 0;
        while (i < bArr.length) {
            int i2;
            if (i + 1 < bArr.length) {
    ...
    byte[] m407a(int i) {
        ...
        short b = (short) (((short) ((63 - (m408b() / 2)) - 1)) & 65535);
        int i2 = 0;
        while (i2 < i) {
            short s = (short) (b + 1);
            int a = m44a(b);
