...
public class D2xxManager {
    ...
    private static List<C0010m> f9e;
    ...
    static {
        ...
        f7c = null;
        f8d = null;
        f9e = new ArrayList(Arrays.asList(new C0010m[]{new C0010m(1027, 24597), new C0010m(1027, 24596), new C0010m(1027, 24593), new C0010m(1027, 24592), new C0010m(1027, 24577), new C0010m(1027, 24582), new C0010m(1027, 24604), new C0010m(1027, 64193), new C0010m(1027, 64194), new C0010m(1027, 64195), new C0010m(1027, 64196), new C0010m(1027, 64197), new C0010m(1027, 64198), new C0010m(1027, 24594), new C0010m(2220, 4133), new C0010m(5590, FT_DEVICE_8U232AM), new C0010m(1027, 24599)}));
        f11i = new C00012();
    }
    ...
    public boolean isFtDevice(UsbDevice dev) {
        boolean z = false;
        if (f6b != null) {
            C0010m c0010m = new C0010m(dev.getVendorId(), dev.getProductId());
            if (f9e.contains(c0010m)) {
                z = true;
            }
            Log.v("D2xx::", c0010m.toString());
        }
        return z;
    }
    ...
    public boolean setVIDPID(int vendorId, int productId) {
        ...
        if (vendorId == 0 || productId == 0) {
            ...
            C0010m c0010m = new C0010m(vendorId, productId);
            if (f9e.contains(c0010m)) {
                Log.i("D2xx::", "Existing vid:" + vendorId + "  pid:" + productId);
                return true;
            } else if (f9e.add(c0010m)) {
                z = true;
            } else {
    ...
    public int[][] getVIDPID() {
        ...
        for (int i = FT_DEVICE_232B; i < size; i += FT_DEVICE_8U232AM) {
            C0010m c0010m = (C0010m) f9e.get(i);
            iArr[FT_DEVICE_232B][i] = c0010m.m57a();
            iArr[FT_DEVICE_8U232AM][i] = c0010m.m58b();
        }
        return iArr;
    }
