...
public class ExtractAssets {
    ...
    static {
        f534a = ExtractAssets.class.getSimpleName();
    }
    ...
    public static ArrayList<String> ExtractToStorage(Context context, ArrayList<String> files, boolean useInternalStorage) throws IOException {
        ...
        while (it.hasNext()) {
            m317a(context, (String) it.next(), useInternalStorage, arrayList);
            if (arrayList != null) {
                Log.d(f534a, "got " + arrayList.size() + " elements");
            }
        }
        return arrayList;
    }

    private static ArrayList<String> m317a(Context context, String str, boolean z, ArrayList<String> arrayList) {
        String[] list;
        InputStream open;
        ...
        Log.d(f534a, "Extracting assests for " + str);
        ...
        if (list.length == 0) {
            try {
                ...
                try {
                    File filesDir;
                    Log.d(f534a, "File: " + str + " opened for streaming");
                    ...
                    if (arrayList == null || !arrayList.contains(concat)) {
                        ...
                        if (file.mkdirs()) {
                            Log.d(f534a, "Dir created " + substring);
                        }
                            ...
                            try {
                                ...
                                if (open != null) {
                                    try {
                                        ...
                                        Log.d(f534a, "Unable to close in stream");
                                        e2.printStackTrace();
                                    }
                                    if (fileOutputStream3 != null) {
                                        try {
                                            ...
                                            Log.d(f534a, "Unable to close out stream");
                                            e3.printStackTrace();
                                        }
                                    }
                                }
                                ...
                                inputStream = open;
                                try {
                                    Log.d(f534a, "File: " + str + " doesn't exist");
                                    if (inputStream != null) {
                                        try {
                                            inputStream.close();
                        ...
                        Log.e(f534a, "Ignoring Duplicate entry for " + concat);
                        if (open != null) {
                            try {
                                open.close();
        ...
        for (String concat2 : list) {
            m317a(context, str.concat(concat2), z, arrayList);
        }
        return arrayList;
    }
}
