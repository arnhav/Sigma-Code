...
public class Pose {
    ...
    public double getDistanceInMm() {
        return Math.sqrt((Math.pow(this.transX, FtcDriverStationActivity.ASSUME_DISCONNECT_TIMER) + Math.pow(this.transY, FtcDriverStationActivity.ASSUME_DISCONNECT_TIMER)) + Math.pow(this.transZ, FtcDriverStationActivity.ASSUME_DISCONNECT_TIMER));
    }
}
