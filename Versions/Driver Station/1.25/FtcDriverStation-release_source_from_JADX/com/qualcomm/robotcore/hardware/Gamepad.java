...
public class Gamepad implements RobocolParsable {
    ...
    private static Set<Integer> f682d;
    private static Set<C0107a> f683e;
    public boolean f684a;
    public boolean f685b;
    public boolean back;
    private final GamepadCallback f686c;
    ...
    private static class C0107a extends SimpleEntry<Integer, Integer> {
    ...
    public void reset() {
        try {
            ...
            RobotLog.m328e("Gamepad library in an invalid state");
    ...
    public void update(KeyEvent event) {
        ...
        if (keyCode == 19) {
            ...
            this.f684a = pressed(event);
        } else if (keyCode == 97) {
            this.f685b = pressed(event);
        } else if (keyCode == 99) {
            this.f687x = pressed(event);
        } else if (keyCode == 100) {
            this.f688y = pressed(event);
        } else if (keyCode == 110) {
        ...
        } else if (keyCode == EditLegacyModuleControllerActivity.EDIT_MATRIX_CONTROLLER_REQUEST_CODE) {
            this.right_bumper = pressed(event);
        } else if (keyCode == EditLegacyModuleControllerActivity.EDIT_SERVO_CONTROLLER_REQUEST_CODE) {
    ...
    protected void callCallback() {
        if (this.f686c != null) {
            this.f686c.gamepadChanged(this);
        }
    }
    ...
    public static void enableWhitelistFilter(int vendorId, int productId) {
        ...
        f683e.add(new C0107a(vendorId, productId));
    }
    ...
    public static synchronized boolean isGamepadDevice(int deviceId) {
        ...
        synchronized (Gamepad.class) {
            if (!f682d.contains(Integer.valueOf(deviceId))) {
                f682d = new HashSet();
                for (int i : InputDevice.getDeviceIds()) {
                    ...
                    if ((sources & 1025) == 1025 || (sources & 16777232) == 16777232) {
                        if (VERSION.SDK_INT < 19) {
                            f682d.add(Integer.valueOf(i));
                        } else if (f683e == null || f683e.contains(new C0107a(device.getVendorId(), device.getProductId()))) {
                            f682d.add(Integer.valueOf(i));
                        }
                    }
                }
