...
public class Utility {
    ...
    private static int f471c;
    private Activity f472a;
    private SharedPreferences f473b;
    private WriteXMLFileHandler f474d;
    ...
    static /* synthetic */ class C01081 {
        ...
        static {
            f470a = new int[DeviceType.values().length];
            try {
                f470a[DeviceType.MODERN_ROBOTICS_USB_DC_MOTOR_CONTROLLER.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f470a[DeviceType.MODERN_ROBOTICS_USB_SERVO_CONTROLLER.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f470a[DeviceType.MODERN_ROBOTICS_USB_LEGACY_MODULE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f470a[DeviceType.MODERN_ROBOTICS_USB_DEVICE_INTERFACE_MODULE.ordinal()] = 4;
    ...
    public Utility(Activity activity) {
        this.f472a = activity;
        this.f473b = PreferenceManager.getDefaultSharedPreferences(activity);
        this.f474d = new WriteXMLFileHandler(activity);
    }
    ...
    public void createConfigFolder() {
        ...
        if (!z) {
            RobotLog.m328e("Can't create the Robot Config Files directory!");
            complainToast("Can't create the Robot Config Files directory!", this.f472a);
        }
    }
    ...
    public ArrayList<String> getXMLFiles() {
        ...
        if (listFiles == null) {
            RobotLog.m329i("robotConfigFiles directory is empty");
    ...
    public boolean writeXML(Map<SerialNumber, ControllerConfiguration> deviceControllers) {
        ...
        try {
            this.f475e = this.f474d.writeXml(arrayList);
        } catch (RuntimeException e) {
            if (e.getMessage().contains("Duplicate name")) {
                complainToast("Found " + e.getMessage(), this.f472a);
                RobotLog.m328e("Found " + e.getMessage());
                return true;
            }
        }
        return false;
    ...
    public void writeToFile(String filename) throws RobotCoreException, IOException {
        this.f474d.writeToFile(this.f475e, CONFIG_FILES_DIR, filename);
    }
    ...
    public void createLists(Set<Entry<SerialNumber, DeviceType>> entries, Map<SerialNumber, ControllerConfiguration> deviceControllers) {
        for (Entry entry : entries) {
            switch (C01081.f470a[((DeviceType) entry.getValue()).ordinal()]) {
    ...
    public DeviceInterfaceModuleConfiguration buildDeviceInterfaceModule(SerialNumber serialNumber) {
        DeviceInterfaceModuleConfiguration deviceInterfaceModuleConfiguration = new DeviceInterfaceModuleConfiguration("Device Interface Module " + f471c, serialNumber);
    ...
    public LegacyModuleControllerConfiguration buildLegacyModule(SerialNumber serialNumber) {
        LegacyModuleControllerConfiguration legacyModuleControllerConfiguration = new LegacyModuleControllerConfiguration("Legacy Module " + f471c, createLegacyModuleList(), serialNumber);
        f471c++;
    ...
    public ServoControllerConfiguration buildServoController(SerialNumber serialNumber) {
        ServoControllerConfiguration servoControllerConfiguration = new ServoControllerConfiguration("Servo Controller " + f471c, createServoList(), serialNumber);
        f471c++;
        return servoControllerConfiguration;
    }

    public MotorControllerConfiguration buildMotorController(SerialNumber serialNumber) {
        MotorControllerConfiguration motorControllerConfiguration = new MotorControllerConfiguration("Motor Controller " + f471c, createMotorList(), serialNumber);
        f471c++;
    ...
    public void updateHeader(String default_name, int pref_hardware_config_filename_id, int fileTextView, int header_id) {
        String replaceFirst = this.f473b.getString(this.f472a.getString(pref_hardware_config_filename_id), default_name).replaceFirst("[.][^.]+$", BuildConfig.VERSION_NAME);
        ((TextView) this.f472a.findViewById(fileTextView)).setText(replaceFirst);
    ...
    public void saveToPreferences(String filename, int pref_hardware_config_filename_id) {
        ...
        Editor edit = this.f473b.edit();
        edit.putString(this.f472a.getString(pref_hardware_config_filename_id), filename);
        edit.apply();
    }

    public void changeBackground(int color, int header_id) {
        ((LinearLayout) this.f472a.findViewById(header_id)).setBackgroundColor(color);
    }

    public String getFilenameFromPrefs(int pref_hardware_config_filename_id, String default_name) {
        return this.f473b.getString(this.f472a.getString(pref_hardware_config_filename_id), default_name);
    }
    ...
    public void setOrangeText(String msg0, String msg1, int info_id, int layout_id, int orange0, int orange1) {
        LinearLayout linearLayout = (LinearLayout) this.f472a.findViewById(info_id);
        linearLayout.setVisibility(0);
        linearLayout.removeAllViews();
        this.f472a.getLayoutInflater().inflate(layout_id, linearLayout, true);
    ...
    public void confirmSave() {
        Toast makeText = Toast.makeText(this.f472a, "Saved", 0);
        makeText.setGravity(80, 0, 50);
        makeText.show();
    }

    public Builder buildBuilder(String title, String message) {
        Builder builder = new Builder(this.f472a);
