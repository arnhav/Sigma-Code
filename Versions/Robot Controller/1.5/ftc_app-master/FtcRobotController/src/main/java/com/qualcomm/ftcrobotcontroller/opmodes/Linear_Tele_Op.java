...
public class Linear_Tele_Op extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()){
             ...
             */
            if (gamepad2.dpad_up){
                acsL.setPosition(1.0);
            }
            if (gamepad2.dpad_down){
                acsL.setPosition(0.0);
            }
            if (gamepad2.a){
                acsR.setPosition(0.0);
            }
            if (gamepad2.y){
                acsR.setPosition(1.0);
            }
            ...
            telemetry.addData("ACSL", acsL.getPosition());
            telemetry.addData("ACSR", acsR.getPosition());
